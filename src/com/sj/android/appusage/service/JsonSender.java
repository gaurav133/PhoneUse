...
public class JsonSender implements ReportSender {
 ...
 private static final String LOG_TAG = JsonSender.class.getSimpleName();
static {
...
JSONObject email_json = new JSONObject();
 email_json.put("email", "androiddeveloperatwork@gmail.com"); // recipient email address goes here
 email_json.put("name", "Gaurav"); // receiver's name..can be changed
...
JSONObject jsonObject = new JSONObject();
 jsonObject.put("key", "n0rSKePOFLMqjCvo9pLzAA");
