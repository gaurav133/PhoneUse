package com.sj.android.appusage.database;
...
import com.sj.android.appusage.database.PhoneUsageDbHelper.Columns;
import com.sj.android.appusage.database.PhoneUsageDbHelper.Table;
...
public class PhoneUsageDatabase {
    ...
    public void exportDatabse(String databaseName) {
        try {
			...
			if (sd.canWrite()) {
				String currentDBPath = "//data//" + "com.sj.android.appusage"
