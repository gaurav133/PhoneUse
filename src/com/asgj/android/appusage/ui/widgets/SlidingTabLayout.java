...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public static final int TAB_VIEW_TEXT_SIZE_SP = 10;
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if (tabView == null) {
                ...
                if(tabViewParams == null)
                	tabViewParams = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
